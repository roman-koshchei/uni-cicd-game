...
class TestGhost:
    def test_ghost_initialization(self, node, mock_ghost_sprites):
        ...
        # Mock the sprites
        with patch('styles.sprite.sprites.GhostSprites', return_value=MagicMock()) as mock_sprites:
...
class TestGhostGroup:
    ...
    def test_ghost_group_initialization(self, MockClyde, MockInky, MockPinky, MockBlinky, node):
    ...
    @patch('ghosts.ghost.Inky')
    @patch('ghosts.ghost.Clyde')
    def test_ghost_group_start_freight(self, MockClyde, MockInky, MockPinky, MockBlinky, node):
