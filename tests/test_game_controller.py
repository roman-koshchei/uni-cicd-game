...
class TestGameController:
    ...
    def test_game_controller_initialization(
        self, mock_set_mode, mock_init, mock_text_group, mock_life_sprites
    ):
    ...
    def test_render(
        self, mock_update, mock_set_mode, mock_init, mock_text_group, mock_life_sprites
    ):
